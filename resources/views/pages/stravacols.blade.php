	...
	@foreach($cols as $col)
					<div class="align-items-end d-flex">
						<div class="text-truncate">
							<img src="/images/flags/{{$col->Country1IDString}}.gif" title="{{$col->Country1}}" class="flag mr-1">
		@if ($col->Country2)
							<img src="/images/flags/{{$col->Country2IDString}}.gif" title="{{$col->Country2}}" class="flag mr-1">
		@endif
							{{$col->Col}}
						</div>
