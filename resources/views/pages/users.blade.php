...
?>
					<div class="px-2 py-0 align-items-end d-flex">
						...
						<img src="/images/flags/{{$following_->Country1IDString}}.gif" title="{{$following_->Country1}}" data-toggle="tooltip" class="flag mx-1">
		@if ($following_->Country2)
						<img src="/images/flags/{{$following_->Country2IDString}}.gif" title="{{$following_->Country2}}" data-toggle="tooltip" class="flag mr-1">
		@endif					
...
@foreach ($countries as $country)
					<div class="align-items-end d-flex">
						<img src="/images/flags/{{$country->CountryIDString}}.gif" title="{{$country->Country}}" class="flag mr-1">
						<div class="text-truncate">
	@if ($country->Col)
...
@foreach($cols_most as $cols_most_)
						<div class="align-items-end d-flex">
							<div class="text-truncate">
								<img src="/images/flags/{{$cols_most_->Country1IDString}}.gif" title="{{$cols_most_->Country1}}" data-toggle="tooltip" class="flag mr-1">
	@if ($cols_most_->Country2)
								<img src="/images/flags/{{$cols_most_->Country2IDString}}.gif" title="{{$cols_most_->Country2}}" data-toggle="tooltip" class="flag mr-1">
	@endif
...
@foreach($cols_most_year as $cols_most_year_)
						<div class="align-items-end d-flex">
							<div class="text-truncate">
								<img src="/images/flags/{{$cols_most_year_->Country1IDString}}.gif" title="{{$cols_most_year_->Country1}}" data-toggle="tooltip" class="flag mr-1">
	@if ($cols_most_year_->Country2)
								<img src="/images/flags/{{$cols_most_year_->Country2IDString}}.gif" title="{{$cols_most_year_->Country2}}" data-toggle="tooltip" class="flag mr-1">
	@endif
...
@foreach($cols_most_following as $cols_most_following_)
						<div class="align-items-end d-flex">
							<div class="text-truncate">
								<img src="/images/flags/{{$cols_most_following_->Country1IDString}}.gif" title="{{$cols_most_following_->Country1}}" data-toggle="tooltip" class="flag mr-1">
	@if ($cols_most_following_->Country2)
								<img src="/images/flags/{{$cols_most_following_->Country2IDString}}.gif" title="{{$cols_most_following_->Country2}}" data-toggle="tooltip" class="flag mr-1">
	@endif
