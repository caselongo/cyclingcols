	...
	<div class="container-fluid font-weight-light">
		<div class="row px-2">
			<div class="col-xs-12 col-md-6 col-lg-8">
				...
				<p>
					If you have a question about this website or myself, or if you want to advertise or cooperate, please send en email to <a href="mailto:info@cyclingcols.com">info@cyclingcols.com</a>.
				</p>
				<p>
