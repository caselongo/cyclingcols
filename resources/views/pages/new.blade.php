...
?>	
			<div class="card mb-4">
				<div class="card-img-top card-img-background" onclick='goToCol("{{$newitem->ColIDString}}")' style='background-position: 50% {{$coverPhotoPosition}}%; background-image: url("{{env('IMAGES_PATH','/images')}}/covers/small/{{$coverPhoto}}.jpg")'>
@if ($newitem->IsNew)
...
@endif
				...
				<div class="card-body p-0">
					<h6 class="card-title p-2 m-0 font-weight-light">
						<img src="/images/flags/{{$newitem->Country1IDString}}.gif" title="{{$newitem->Country1}}" data-toggle="tooltip" class="flag">
@if ($newitem->Country2)
						<img src="/images/flags/{{$newitem->Country2IDString}}.gif" title="{{$newitem->Country2}}" data-toggle="tooltip" class="flag flag2">
@endif
