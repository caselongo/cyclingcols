...
<header>
	<nav class="navbar navbar-expand-sm navbar-dark bg-dark pb-0">
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		@endguest
		  ...
		  <li class="nav-item d-flex align-items-center">
			<a class="nav-link" href="https://www.instagram.com/_cyclingcols_" target="_blank"><i class="fab fa-instagram"></i></a>
		  </li> 
		</ul> 
		@if (!$home)	
	...
	<div class="bg-dark font-weight-light text-white px-5 text-center text-small-90">
		...
		<div class="px-2 d-inline">Discover the climbs of the 
			<span class="text-nowrap"><a href="/list/giro_d_italia_2021">Giro 2021</a> <img class="flag" src="/images/flags/Italy.gif"></span>,
			<span class="text-nowrap"><a href="/list/tour_de_france_2021">Tour 2021</a> <img class="flag" src="/images/flags/France.gif"></span> and
			<span class="text-nowrap"><a href="/list/vuelta_a_espana_2021">Vuelta 2021</a> <img class="flag" src="/images/flags/Spain.gif"></span>
		</div>
	</div>
</header>
